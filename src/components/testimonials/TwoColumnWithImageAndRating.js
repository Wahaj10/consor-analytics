...
import loveIllustrationImageSrc from "images/cover.jpg";
...
export default ({
  ...
  imageShadow = false,
  subheading = "",
  heading = "Transform Your Business with Advanced Data Analytics.",
  description = "Discover the untapped potential of your business through our data analytics expertise at Consor. Harness valuable insights to drive strategic decision-making, achieve remarkable growth, and gain a competitive advantage in the market.",
  textOnLeft = false,
  testimonials = [
    {
      profileImageSrc:
